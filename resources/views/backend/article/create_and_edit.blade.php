    ...
    <div class="layui-main">
        ...
        <form class="layui-form layui-form-pane" method="POST" action="{{ $article->id ? route('articles.update', $article->id) : route('articles.store') }}?redirect={{ previous_url() }}">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    {{--<div id="editor"></div>--}}
                    <textarea name="content" lay-verify="" id="content" placeholder="内容" class="layui-textarea editor" style="display: none;">{{  old('content', $article->content) }}</textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" id="created_at" name="created_at" placeholder="yyyy-MM-dd HH:mm:ss">
                </div>
            </div>
            @if($type)
...
@section('scripts')
    ...
    {{--@include('backend.common._ck_editor_sripts',['folder'=>'article', 'object_id'=>$object_id,'content'=> str_replace("\n","",old('content', $article->content))])--}}
    @include('backend.common._code_date_scripts',['date'=>$article->created_at])
@stop