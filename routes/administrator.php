...
Route::group(['domain' => config('administrator.domain'), 'prefix' => config('administrator.uri'), 'namespace' => 'Administrator', 'middleware' => ['auth'], ], function () {
    ...
    # banner相关路由
    Route::put('banners/order','BannerController@order')->name('banners.order');
    Route::resource('banners', 'BannerController', ['only' => ['index', 'show',  'create', 'store', 'update', 'edit', 'destroy']]);
